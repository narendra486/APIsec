...
execute_request = {
    "tool": "execute_tests",
    "arguments": {"mode": "safe", "max_concurrency": 5, "time_budget_seconds": 300},
}
...
config_request = {
    ...
    "arguments": {
        "mode": "safe",
        "allowlist": ["https://api.example.com/*", "https://staging-api.example.com/*"],
...
example_output = {
    ...
    "top_tests": [
        ...
        },
        {
            ...
            "method": "POST",
            "position": {"type": "header", "name": "Authorization", "inferred_type": "jwt"},
            "test_type": "jwt-vuln",
        ...
        },
        {
            ...
            "endpoint": "/api/users",
            "method": "GET",
            "position": {"type": "query", "name": "q", "inferred_type": "string"},
            "test_type": "sqli",
            "payload": "test' OR '1'='1",
        ...
        },
        {
            ...
            "endpoint": "/api/users",
            "method": "POST",
            "position": {"type": "body-json", "path": "$.username", "inferred_type": "string"},
            "test_type": "xss",
        ...
        },
        {
            ...
            "method": "DELETE",
            "position": {"type": "path", "name": "id", "inferred_type": "integer"},
