...
SUPPLY_CHAIN_FAILURE_VECTORS = [
    TestVector(
        ...
        expected_evidence=TestVectorEvidence(indicators=["Unexpected network connections", "Malicious process execution"], confidence=ConfidenceLevel.HIGH),
    ...
    TestVector(
        ...
        expected_evidence=TestVectorEvidence(indicators=["Unexpected package behavior", "Telemetry exfiltration"], confidence=ConfidenceLevel.MEDIUM),
    ...
    TestVector(
        ...
        expected_evidence=TestVectorEvidence(indicators=["Unexpected code in build artifacts"], confidence=ConfidenceLevel.HIGH),
        sensitivity=SensitivityLevel.HIGH,
    ...
    TestVector(
        ...
        expected_evidence=TestVectorEvidence(indicators=["Unexpected dependency updates"], confidence=ConfidenceLevel.MEDIUM),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        expected_evidence=TestVectorEvidence(indicators=["Lack of signature verification"], confidence=ConfidenceLevel.MEDIUM),
        sensitivity=SensitivityLevel.MEDIUM,
