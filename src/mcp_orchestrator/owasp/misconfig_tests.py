...
MISCONFIGURATION_VECTORS = [
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="credentials", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        payload=PayloadTemplate(base="true", variants=["true", "1", "on"], encoding="none"),
        expected_evidence=Evidence(
            indicators=[
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            base="invalid_value'\"<>", variants=["'", '"', "<script>", "{{7*7}}"], encoding="none"
        ),
        expected_evidence=Evidence(
            indicators=[
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.PATH, name="backup_file", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="config.php.bak",
            variants=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_MISCONFIGURATION,
        position=Position(
            type=PositionType.PATH, name="source_file", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="index.php.txt",
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_MISCONFIGURATION,
        position=Position(
            type=PositionType.PATH, name="admin_path", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="/admin",
            variants=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_MISCONFIGURATION,
        position=Position(
            type=PositionType.PATH, name="docs_path", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="/api-docs",
            variants=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_MISCONFIGURATION,
        position=Position(
            type=PositionType.PATH, name="env_file", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="/.env",
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_MISCONFIGURATION,
        position=Position(
            type=PositionType.PATH, name="git_path", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="/.git/config",
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_MISCONFIGURATION,
        position=Position(
            type=PositionType.PATH, name="sensitive_path", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_MISCONFIGURATION,
        position=Position(
            type=PositionType.HEADER, name="Cache-Control", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(base="", variants=["public", "max-age=3600"], encoding="none"),
        expected_evidence=Evidence(
