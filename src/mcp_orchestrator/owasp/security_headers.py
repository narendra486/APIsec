...
SECURITY_HEADER_VECTORS = [
    TestVector(
        ...
        position=Position(type=PositionType.HEADER, name="Content-Security-Policy", value_prefix="", value_suffix=""),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_HEADER_MISSING,
        position=Position(type=PositionType.HEADER, name="Strict-Transport-Security", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="",
            variants=["", "max-age=0", "max-age=300"],
            encoding="none"
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_HEADER_MISSING,
        position=Position(type=PositionType.HEADER, name="X-Frame-Options", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="",
            variants=["", "ALLOWALL"],
            encoding="none"
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["No X-Content-Type-Options", "MIME sniffing enabled", "Content type confusion"],
            confidence=ConfidenceLevel.MEDIUM
        ),
        sensitivity=SensitivityLevel.LOW,
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_HEADER_MISSING,
        position=Position(type=PositionType.HEADER, name="Referrer-Policy", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="",
            variants=["", "unsafe-url"],
            encoding="none"
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_HEADER_MISSING,
        position=Position(type=PositionType.HEADER, name="Permissions-Policy", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="",
            variants=[""],
            encoding="none"
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_HEADER_MISSING,
        position=Position(type=PositionType.HEADER, name="Cross-Origin-Resource-Policy", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="",
            variants=[""],
            encoding="none"
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_HEADER_MISSING,
        position=Position(type=PositionType.HEADER, name="Cross-Origin-Embedder-Policy", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="",
            variants=[""],
            encoding="none"
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SECURITY_HEADER_MISSING,
        position=Position(type=PositionType.HEADER, name="Expect-CT", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="",
            variants=[""],
            encoding="none"
