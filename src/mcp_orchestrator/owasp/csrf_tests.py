...
CSRF_VECTORS = [
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_FORM, name="csrf_token", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(base="", variants=["<missing>"], encoding="none"),
    ...
    TestVector(
        ...
        payload=PayloadTemplate(base="", variants=["", " ", "null", "undefined"], encoding="none"),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=[
                "Token accepted across sessions",
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            ...
            variants=["session=valid_session_id; SameSite=None", "session=valid_session_id"],
            encoding="none",
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            ...
            variants=['{"action":"delete_account"}', '{"action":"transfer_funds","amount":1000}'],
            encoding="none",
        ),
        expected_evidence=Evidence(
            indicators=[
                "JSON CSRF successful",
    ...
    TestVector(
        ...
        payload=PayloadTemplate(base="PUT", variants=["PUT", "DELETE", "PATCH"], encoding="none"),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            ...
            variants=["https://attacker.trusted-domain.com", "https://xss.trusted-domain.com"],
            encoding="none",
        ),
        expected_evidence=Evidence(
