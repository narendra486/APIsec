...
OPEN_REDIRECT_VECTORS = [
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Redirect to external domain", "Location header to evil.com", "User redirected"],
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Redirect based on Referer", "Location to attacker site", "Referer-based routing"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["JavaScript protocol execution", "Client-side redirect", "window.location assignment"],
            confidence=ConfidenceLevel.HIGH
        ),
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Meta refresh tag in response", "Auto-redirect to external site", "0;url= in HTML"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Custom protocol handler invoked", "Application opened", "Protocol redirect"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.HIGH,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["DOM redirect executed", "window.location modified", "Fragment-based redirect"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.MEDIUM,
