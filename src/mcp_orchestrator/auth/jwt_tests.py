...
class JWTTestVectors:
    ...
    def get_test_vectors() -> List[PayloadTemplate]:
        ...
        test_vectors.append(PayloadTemplate(
            id="jwt-001-alg-none",
            ...
            applicable_positions=[PositionType.HEADER, PositionType.COOKIE, PositionType.BODY_JSON],
        ...
        header_b64 = JWTTestVectors.base64url_encode(json.dumps({"alg": "HS256", "typ": "JWT"}).encode())
        payload_b64 = JWTTestVectors.base64url_encode(json.dumps({"sub": "admin", "exp": future_time}).encode())
        test_vectors.append(PayloadTemplate(
        ...
        payload_b64_role = JWTTestVectors.base64url_encode(json.dumps({"sub": "user", "role": "admin", "exp": future_time}).encode())
        test_vectors.append(PayloadTemplate(
        ...
        payload_aud = JWTTestVectors.base64url_encode(json.dumps({"sub": "user", "aud": "admin-service", "exp": future_time}).encode())
        test_vectors.append(PayloadTemplate(
        ...
        payload_iss = JWTTestVectors.base64url_encode(json.dumps({"sub": "user", "iss": "trusted-issuer", "exp": future_time}).encode())
        test_vectors.append(PayloadTemplate(
