...
OAUTH_TEST_VECTORS = [
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            ...
            variants=[
                "<SAME_CODE_SECOND_REQUEST>",
                "<SAME_CODE_THIRD_REQUEST>"
            ],
            encoding="none"
        ),
        expected_evidence=Evidence(
