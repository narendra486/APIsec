...
MFA_TEST_VECTORS = [
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="mfa_code", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="<CAPTURED_MFA_CODE>", variants=["<SAME_CODE_REUSED>"], encoding="none"
        ),
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="backup_code", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.MFA_BYPASS,
        position=Position(
            type=PositionType.BODY_JSON, name="mfa_required", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="false", variants=["false", "0", "null", "undefined", ""], encoding="none"
        ),
        expected_evidence=Evidence(
            indicators=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.MFA_BYPASS,
        position=Position(
            type=PositionType.HEADER, name="X-MFA-Status", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="verified", variants=["verified", "success", "complete", "bypass"], encoding="none"
        ),
        expected_evidence=Evidence(
            indicators=[
            ...
            false_positive_indicators=["Header ignored", "MFA still enforced"],
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.MFA_BYPASS,
        position=Position(
            type=PositionType.COOKIE, name="mfa_session", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="<ATTACKER_CONTROLLED_SESSION>", variants=["fixed_session_12345"], encoding="none"
        ),
        expected_evidence=Evidence(
            indicators=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.MFA_BYPASS,
        position=Position(
            type=PositionType.BODY_JSON, name="totp_code", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="<TOTP_CODE_FROM_10_MINUTES_AGO>", variants=["<OLD_TOTP_CODE>"], encoding="none"
        ),
        expected_evidence=Evidence(
            indicators=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.MFA_BYPASS,
        position=Position(
            type=PositionType.BODY_JSON, name="phone_number", value_prefix="+1", value_suffix=""
        ),
        payload=PayloadTemplate(base="<ATTACKER_PHONE>", variants=["+1234567890"], encoding="none"),
        expected_evidence=Evidence(
            indicators=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.MFA_BYPASS,
        position=Position(
            type=PositionType.COOKIE, name="mfa_remember_token", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="<STOLEN_REMEMBER_TOKEN>", variants=["permanent_token_12345"], encoding="none"
        ),
        expected_evidence=Evidence(
            indicators=[
