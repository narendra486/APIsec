...
SESSION_TEST_VECTORS = [
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            base="<OLD_SESSION_TOKEN>",
            variants=[
                "<SESSION_FROM_30_DAYS_AGO>"
            ],
            encoding="none"
        ),
        expected_evidence=Evidence(
