...
WORKFLOW_ATTACK_VECTORS = [
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="step", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base='{"step":5}',
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="state", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.HEADER, name="Idempotency-Key", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(base="", variants=["", "new-key-each-time"], encoding="none"),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="payment_status", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="approved", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base='{"approved":true}',
            variants=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.BUSINESS_LOGIC_RACE_CONDITION,
        position=Position(
            type=PositionType.BODY_JSON, name="action", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="force_error", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="async_op", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="coupons", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="points", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.BUSINESS_LOGIC_SESSION_FIXATION,
        position=Position(
            type=PositionType.HEADER, name="Cookie", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
        ...
        expected_evidence=Evidence(
            indicators=[
                "Session accepted pre-authentication",
                "MFA bypassed",
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.BUSINESS_LOGIC_STEP_SKIP,
        position=Position(
            type=PositionType.BODY_JSON, name="captcha_validated", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(base="true", variants=["true", "1"], encoding="none"),
        expected_evidence=Evidence(
