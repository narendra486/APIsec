...
FINANCIAL_TEST_VECTORS = [
    TestVector(
        ...
        position=Position(type=PositionType.BODY_JSON, name="price", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="-100",
            variants=["-100", "-0.01", "-99999"],
            encoding="none"
        ),
    ...
    TestVector(
        ...
        position=Position(type=PositionType.BODY_JSON, name="quantity", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="-1",
            variants=["-1", "-100", "-99999"],
            encoding="none"
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        position=Position(type=PositionType.BODY_JSON, name="discount", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="2147483648",
            variants=["2147483648", "-2147483648"],
            encoding="none"
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        position=Position(type=PositionType.BODY_JSON, name="currency", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        position=Position(type=PositionType.BODY_JSON, name="discounts", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        position=Position(type=PositionType.BODY_JSON, name="refund_amount", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="99999",
            variants=["99999", "original_price * 2", "-100"],
            encoding="none"
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        position=Position(type=PositionType.BODY_JSON, name="add_credit", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="99999",
            variants=["99999", "-1000", "2147483647"],
            encoding="none"
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Rounding in user's favor", "Accumulated rounding errors", "Salami slicing"],
            confidence=ConfidenceLevel.MEDIUM
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.BUSINESS_LOGIC_PRICE_MANIPULATION,
        position=Position(type=PositionType.BODY_JSON, name="tax_rate", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="0",
            variants=["0", "-0.1", "0.0000001"],
            encoding="none"
        ),
        expected_evidence=Evidence(
