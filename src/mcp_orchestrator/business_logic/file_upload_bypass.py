...
FILE_UPLOAD_BYPASS_VECTORS = [
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Missing X-Content-Type-Options", "Browser sniffs content type", "Script execution"],
            confidence=ConfidenceLevel.MEDIUM
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            base=".htaccess",
            variants=[".htaccess", "htaccess.txt"],
            encoding="none"
        ),
        expected_evidence=Evidence(
            indicators=[".htaccess uploaded", "AddHandler directives active", "Code execution enabled"],
            confidence=ConfidenceLevel.CRITICAL
        ),
        sensitivity=SensitivityLevel.CRITICAL,
