...
class TestVectorRegistry:
    ...
    def _register_all_vectors(self):
        ...
        self._register_collection(
            EXCEPTIONAL_CONDITIONS_VECTORS, "Mishandling of Exceptional Conditions"
        )
...
def print_registry_stats():
    ...
    print(
        f"   SUBTOTAL: {stats['oauth_vectors'] + stats['saml_vectors'] + stats['mfa_vectors'] + stats['session_vectors'] + stats['authorization_vectors']} vectors"
    )
    ...
    print(
        f"   SUBTOTAL: {stats['ssti_vectors'] + stats['nosql_vectors'] + stats['ldap_vectors'] + stats['command_adv_vectors']} vectors"
    )
    ...
    print(
        f"   SUBTOTAL: {stats['graphql_vectors'] + stats['schema_vectors'] + stats['rate_limit_vectors'] + stats['rest_vectors']} vectors"
    )
    ...
    print(
        f"   SUBTOTAL: {stats['workflow_vectors'] + stats['financial_vectors'] + stats['file_upload_vectors']} vectors"
    )
    ...
    print(
        f"   SUBTOTAL: {stats['security_header_vectors'] + stats['misconfiguration_vectors'] + stats['supply_chain_failure_vectors'] + stats['exceptional_conditions_vectors']} vectors"
    )
