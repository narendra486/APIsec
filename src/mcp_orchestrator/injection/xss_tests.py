...
XSS_VECTORS = [
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.XSS,
        position=Position(
            type=PositionType.BODY_JSON, name="comment", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.XSS,
        position=Position(
            type=PositionType.BODY_JSON, name="html", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.XSS,
        position=Position(
            type=PositionType.BODY_JSON, name="style", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
