...
NOSQL_TEST_VECTORS = [
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="password", value_prefix="", value_suffix=""
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.NOSQL_MONGODB,
        position=Position(
            type=PositionType.BODY_JSON, name="pipeline", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="selector", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base='{"_id":{"$gt":null}}',
            variants=[
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Unauthorized data access", "Query bypass"], confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.HIGH,
