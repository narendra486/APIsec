...
XXE_VECTORS = [
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_XML, name="data", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
        ...
        expected_evidence=Evidence(
            indicators=[
                "HTTP request to attacker domain",
                "External DTD loaded",
                "OOB interaction",
            ],
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.XXE,
        position=Position(
            type=PositionType.BODY_XML, name="soap", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
