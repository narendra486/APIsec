...
XSLT_INJECTION_VECTORS = [
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_XML, name="stylesheet", value_prefix="", value_suffix=""
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.XSLT_INJECTION,
        position=Position(
            type=PositionType.BODY_XML, name="xslt", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.XSLT_INJECTION,
        position=Position(
            type=PositionType.BODY_XML, name="transform", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
