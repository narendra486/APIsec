...
LDAP_TEST_VECTORS = [
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.LDAP_INJECTION,
        position=Position(type=PositionType.BODY_JSON, name="search", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="*)(|(objectClass=*",
            variants=[
                "*)(|(cn=*))",
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Different response for valid vs invalid", "Data enumeration", "Character-by-character extraction"],
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Filter bypass via encoding", "Null byte truncation", "Special character processing"],
            confidence=ConfidenceLevel.MEDIUM
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.LDAP_INJECTION,
        position=Position(type=PositionType.BODY_JSON, name="attribute", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="userPassword",
            variants=[
        ...
        expected_evidence=Evidence(
            indicators=["Sensitive attribute disclosure", "Schema enumeration", "Privilege escalation"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.CRITICAL,
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.LDAP_INJECTION,
        position=Position(type=PositionType.BODY_JSON, name="base_dn", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.LDAP_INJECTION,
        position=Position(type=PositionType.BODY_JSON, name="controls", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
