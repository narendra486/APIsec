...
CRLF_INJECTION_VECTORS = [
    TestVector(
        ...
        position=Position(type=PositionType.QUERY, name="redirect", value_prefix="", value_suffix=""),
        ...
        expected_evidence=Evidence(
            indicators=["Injected header in response", "Set-Cookie in response", "Multiple HTTP responses"],
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.CRLF_INJECTION,
        position=Position(type=PositionType.QUERY, name="username", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
        ...
        expected_evidence=Evidence(
            indicators=["False log entries", "Log pollution", "Injected log lines", "SIEM confusion"],
            confidence=ConfidenceLevel.HIGH
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.CRLF_INJECTION,
        position=Position(type=PositionType.BODY_FORM, name="email", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
        ...
        expected_evidence=Evidence(
            indicators=["Email sent to unintended recipients", "Modified subject", "Additional headers", "BCC/CC added"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.HIGH,
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.CRLF_INJECTION,
        position=Position(type=PositionType.HEADER, name="X-Custom-Header", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
        ...
        expected_evidence=Evidence(
            indicators=["Split HTTP response", "Injected content", "JavaScript execution", "Multiple responses"],
            confidence=ConfidenceLevel.HIGH
        ),
