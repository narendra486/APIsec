...
PROTOTYPE_POLLUTION_VECTORS = [
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="user", value_prefix="", value_suffix=""
        ),
        ...
        expected_evidence=Evidence(
            indicators=[
                "Prototype polluted",
                "isAdmin property on all objects",
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.PROTOTYPE_POLLUTION,
        position=Position(
            type=PositionType.BODY_JSON, name="config", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.PROTOTYPE_POLLUTION,
        position=Position(
            type=PositionType.BODY_JSON, name="options", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=[
                "JSON parsed with __proto__",
                "Prototype pollution after parse",
                "RCE execution",
            ],
            confidence=ConfidenceLevel.HIGH,
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.PROTOTYPE_POLLUTION,
        position=Position(
            type=PositionType.QUERY, name="__proto__[isAdmin]", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="true",
            variants=[
        ...
        expected_evidence=Evidence(
            indicators=[
                "Query string parsed",
                "Prototype polluted via URL",
                "isAdmin on all objects",
            ],
            confidence=ConfidenceLevel.HIGH,
        ),
        sensitivity=SensitivityLevel.HIGH,
