...
XPATH_INJECTION_VECTORS = [
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_XML, name="username", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="admin' or '1'='1",
            variants=["admin' or 1=1 or 'a'='a", "' or '1'='1", "' or 1=1--", "admin') or ('1'='1"],
            encoding="none",
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.XPATH_INJECTION,
        position=Position(
            type=PositionType.BODY_XML, name="query", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.XPATH_INJECTION,
        position=Position(
            type=PositionType.BODY_XML, name="filter", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
