...
SSTI_TEST_VECTORS = [
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            base="{{7*7}}",
            variants=["{{7*7}}", "{{7*'7'}}", "{{config}}", "{{self}}", "${7*7}", "#{7*7}"],
            encoding="none",
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SSTI_JINJA2,
        position=Position(
            type=PositionType.BODY_JSON, name="template", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="{{config.items()}}",
            variants=[
        ...
        expected_evidence=Evidence(
            ...
            false_positive_indicators=["Config access blocked", "Literal string in output"],
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            ...
            false_positive_indicators=["Sandboxed environment blocks access", "Error message"],
            confidence=ConfidenceLevel.CRITICAL,
        ),
        sensitivity=SensitivityLevel.CRITICAL,
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SSTI_JINJA2,
        position=Position(
            type=PositionType.BODY_JSON, name="message", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
        ...
        expected_evidence=Evidence(
            ...
            false_positive_indicators=["Access denied", "Sandboxing prevents execution"],
            confidence=ConfidenceLevel.CRITICAL,
        ),
        sensitivity=SensitivityLevel.CRITICAL,
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            base="{{7*7}}",
            variants=["{{7*7}}", "{{7*'7'}}", "{{_self}}", "{{dump(app)}}"],
            encoding="none",
        ),
        expected_evidence=Evidence(
            indicators=[
            ...
            false_positive_indicators=["Literal '{{7*7}}' in output", "No evaluation"],
            confidence=ConfidenceLevel.HIGH,
        ),
        sensitivity=SensitivityLevel.CRITICAL,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            ...
            false_positive_indicators=["Sandbox prevents execution", "Filter registration blocked"],
            confidence=ConfidenceLevel.CRITICAL,
        ),
        sensitivity=SensitivityLevel.CRITICAL,
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.QUERY, name="template", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="${7*7}",
            variants=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SSTI_FREEMARKER,
        position=Position(
            type=PositionType.BODY_JSON, name="content", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
        ...
        expected_evidence=Evidence(
            indicators=["Command execution output", "System command executed", "RCE confirmed"],
            false_positive_indicators=["Execute class blocked", "Sandbox prevents execution"],
            confidence=ConfidenceLevel.CRITICAL,
        ),
        sensitivity=SensitivityLevel.CRITICAL,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Output contains '49'", "Velocity directive executed", "Command execution"],
            false_positive_indicators=["Literal directive in output", "No evaluation"],
            confidence=ConfidenceLevel.HIGH,
        ),
        sensitivity=SensitivityLevel.CRITICAL,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            ...
            false_positive_indicators=["Literal '{7*7}' in output", "PHP tag disabled"],
            confidence=ConfidenceLevel.HIGH,
        ),
        sensitivity=SensitivityLevel.CRITICAL,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Template evaluated", "Prototype chain traversal", "Code execution"],
            false_positive_indicators=["Sandboxed environment", "Prototype access blocked"],
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            ...
            false_positive_indicators=["No delay observed", "Normal response time"],
            confidence=ConfidenceLevel.MEDIUM,
        ),
        sensitivity=SensitivityLevel.HIGH,
