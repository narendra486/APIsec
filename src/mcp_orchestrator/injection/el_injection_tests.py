...
EL_INJECTION_VECTORS = [
    TestVector(
        ...
        position=Position(
            type=PositionType.QUERY, name="expression", value_prefix="", value_suffix=""
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.EL_INJECTION,
        position=Position(
            type=PositionType.BODY_FORM, name="redirect", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.EL_INJECTION,
        position=Position(
            type=PositionType.QUERY, name="param", value_prefix="${", value_suffix="}"
        ),
        payload=PayloadTemplate(
