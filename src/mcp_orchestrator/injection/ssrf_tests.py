...
SSRF_VECTORS = [
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="url", value_prefix="", value_suffix=""
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SSRF,
        position=Position(
            type=PositionType.BODY_JSON, name="webhook", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SSRF,
        position=Position(
            type=PositionType.BODY_JSON, name="image_url", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SSRF,
        position=Position(
            type=PositionType.BODY_JSON, name="target", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
        ...
        expected_evidence=Evidence(
            indicators=[
                "DNS rebinding successful",
                "Filter bypassed",
                "Internal access via external domain",
            ],
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.SSRF,
        position=Position(
            type=PositionType.BODY_JSON, name="webhook_url", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
