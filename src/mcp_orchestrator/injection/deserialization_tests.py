...
DESERIALIZATION_VECTORS = [
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_FORM, name="user", value_prefix="", value_suffix=""
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.DESERIALIZATION,
        position=Position(
            type=PositionType.COOKIE, name="user_data", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.DESERIALIZATION,
        position=Position(
            type=PositionType.BODY_FORM, name="data", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.DESERIALIZATION,
        position=Position(
            type=PositionType.BODY_FORM, name="__VIEWSTATE", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.DESERIALIZATION,
        position=Position(
            type=PositionType.COOKIE, name="session", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="BAhvOgpDbGFzczYAVQpzeXN0ZW0GOgxAdmFsdWVJIg93aG9hbWkGOgZFVA==",
            variants=["BAhvOgpDbGFzczYAVQpzeXN0ZW0GOgxAdmFsdWVJIg93aG9hbWkGOgZFVA=="],
            encoding="base64",
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.DESERIALIZATION,
        position=Position(
            type=PositionType.COOKIE, name="profile", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.DESERIALIZATION,
        position=Position(
            type=PositionType.BODY_JSON, name="data", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.DESERIALIZATION,
        position=Position(
            type=PositionType.BODY_XML, name="config", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
