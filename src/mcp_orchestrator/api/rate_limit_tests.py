...
RATE_LIMIT_BYPASS_VECTORS = [
    TestVector(
        ...
        position=Position(type=PositionType.HEADER, name="X-Forwarded-For", value_prefix="", value_suffix=""),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.API_RATE_LIMIT_BYPASS,
        position=Position(type=PositionType.HEADER, name="User-Agent", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.API_RATE_LIMIT_BYPASS,
        position=Position(type=PositionType.HEADER, name="X-Real-IP", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="10.0.0.1",
            variants=[
                "10.0.0.1",
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.API_RATE_LIMIT_BYPASS,
        position=Position(type=PositionType.HEADER, name="X-API-Key", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="key1",
            variants=[
                "key1",
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.API_RATE_LIMIT_BYPASS,
        position=Position(type=PositionType.QUERY, name="delay", value_prefix="", value_suffix="ms"),
        payload=PayloadTemplate(
            base="999",
            variants=[
