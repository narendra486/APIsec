...
GRAPHQL_ADVANCED_VECTORS = [
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Infinite recursion", "Server timeout", "High CPU usage", "Memory exhaustion"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.HIGH,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Multiple identical queries executed", "Resource exhaustion", "Slow response"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.HIGH,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Race condition", "Multiple mutations executed", "Business logic bypass", "Inconsistent state"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.CRITICAL,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["WebSocket connection maintained", "Excessive subscription updates", "Resource consumption"],
            confidence=ConfidenceLevel.MEDIUM
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Redundant computation", "Unnecessary database queries", "Performance degradation"],
            confidence=ConfidenceLevel.MEDIUM
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Sensitive fields exposed via fragments", "Type-based authorization bypass"],
            confidence=ConfidenceLevel.MEDIUM
        ),
        sensitivity=SensitivityLevel.HIGH,
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Sensitive fields exposed", "Type confusion successful", "Authorization bypass"],
            confidence=ConfidenceLevel.HIGH
        ),
        sensitivity=SensitivityLevel.HIGH,
