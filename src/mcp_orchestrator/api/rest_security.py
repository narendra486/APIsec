...
REST_SECURITY_VECTORS = [
    TestVector(
        ...
        payload=PayloadTemplate(
            base="HEAD", variants=["HEAD", "OPTIONS", "TRACE", "PUT", "DELETE"], encoding="none"
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.REST_VERB_TAMPERING,
        position=Position(
            type=PositionType.HEADER, name="X-HTTP-Method", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(base="HEAD", variants=["HEAD"], encoding="none"),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        payload=PayloadTemplate(base="OPTIONS", variants=["OPTIONS"], encoding="none"),
        expected_evidence=Evidence(
            indicators=[
                "Sensitive headers exposed",
                "Internal methods revealed",
                "Authentication details disclosed",
            ],
            confidence=ConfidenceLevel.MEDIUM,
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        payload=PayloadTemplate(base="TRACE", variants=["TRACE", "TRACK"], encoding="none"),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            ...
            variants=["application/xml", "text/html", "application/json", "*/*", "text/plain"],
            encoding="none",
        ),
        expected_evidence=Evidence(
            indicators=[
                "Sensitive data in XML format",
                "HTML with debug info",
                "Extra fields in different format",
            ],
            confidence=ConfidenceLevel.MEDIUM,
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        position=Position(
            ...
            name="Content-Type",
            value_prefix="application/json; charset=",
            value_suffix="",
        ),
        payload=PayloadTemplate(
            base="utf-7",
            variants=["utf-7", "utf-16", "utf-32", "iso-8859-1", "windows-1252"],
            encoding="none",
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.REST_VERB_TAMPERING,
        position=Position(
            type=PositionType.PATH, name="path", value_prefix="/uploads/", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="shell.php",
            variants=["shell.php", "../shell.php", "shell.jsp", "backdoor.aspx"],
            encoding="url",
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.PATH, name="resource_id", value_prefix="/api/users/", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="1", variants=["1", "admin", "999", "../users"], encoding="none"
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.BODY_JSON, name="field", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base='{"role":"admin"}',
            variants=[
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.REST_HEADER_INJECTION,
        position=Position(
            type=PositionType.HEADER, name="X-Custom-Admin", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="true", variants=["true", "1", "yes", "admin"], encoding="none"
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        position=Position(
            type=PositionType.HEADER, name="protocol_version", value_prefix="HTTP/", value_suffix=""
        ),
        payload=PayloadTemplate(base="1.0", variants=["1.0", "0.9"], encoding="none"),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        payload=PayloadTemplate(
            base="DELETE", variants=["DELETE", "PUT", "PATCH", "ADMIN"], encoding="none"
        ),
        expected_evidence=Evidence(
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.REST_INFO_DISCLOSURE,
        position=Position(
            type=PositionType.QUERY, name="callback", value_prefix="", value_suffix=""
        ),
        payload=PayloadTemplate(
            base="alert(1);//",
