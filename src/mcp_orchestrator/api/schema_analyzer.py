...
SCHEMA_ANALYZER_VECTORS = [
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Missing security schemes", "No authentication defined", "Empty securitySchemes"],
            confidence=ConfidenceLevel.MEDIUM
        ),
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Invalid parameter accepted", "Type validation missing", "Range validation bypass"],
            confidence=ConfidenceLevel.MEDIUM
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        position=Position(type=PositionType.HEADER, name="X-Debug", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="true",
            variants=[
                "true",
    ...
    TestVector(
        ...
        position=Position(type=PositionType.PATH, name="version", value_prefix="/api/", value_suffix="/users"),
        payload=PayloadTemplate(
            base="v0",
            variants=[
                "v0",
        ...
        expected_evidence=Evidence(
            indicators=["Deprecated version accessible", "Old vulnerabilities exploitable", "Version marked deprecated in schema"],
            confidence=ConfidenceLevel.MEDIUM
        ),
        sensitivity=SensitivityLevel.MEDIUM,
    ...
    TestVector(
        ...
        position=Position(type=PositionType.HEADER, name="X-Request-Count", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
            base="1000",
            variants=["1000", "10000"],
            encoding="none"
        ...
        expected_evidence=Evidence(
            indicators=["No rate limit headers", "Missing X-RateLimit-* headers", "Unlimited requests allowed"],
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Access-Control-Allow-Origin: *", "Reflected origin in CORS header", "Credentials allowed with wildcard"],
