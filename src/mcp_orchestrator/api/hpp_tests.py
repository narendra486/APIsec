...
HPP_VECTORS = [
    ...
    TestVector(
        ...
        expected_evidence=Evidence(
            indicators=["Server uses last/first/concatenated parameter", "Backend confusion", "Different parameter value"],
            confidence=ConfidenceLevel.HIGH
        ),
    ...
    TestVector(
        ...
        vuln_type=VulnerabilityType.HPP,
        position=Position(type=PositionType.QUERY, name="roles[]", value_prefix="", value_suffix=""),
        payload=PayloadTemplate(
